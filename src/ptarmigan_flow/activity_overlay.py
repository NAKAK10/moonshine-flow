...
class AppKitOverlayWindow(OverlayWindowPort):
    ...
    def _clear_backplate_visuals(self) -> None:
        self._glass_layer.setHidden_(True)
        self._glass_layer.setBackgroundColor_(self._color(0.0, 0.0, 0.0, 0.0))
        self._glass_layer.setBorderColor_(self._color(0.0, 0.0, 0.0, 0.0))
        self._glass_layer.setBorderWidth_(0.0)
        self._glass_layer.setShadowColor_(self._color(0.0, 0.0, 0.0, 0.0))
        self._glass_layer.setShadowOpacity_(0.0)
        self._glass_layer.setShadowRadius_(0.0)
        self._glass_layer.setShadowOffset_((0.0, 0.0))
        self._glass_layer.setOpacity_(0.0)

    def _apply_idle_visuals(self) -> None:
        self._clear_backplate_visuals()
        self._glow_layer.setHidden_(True)
        self._ring_a_layer.setHidden_(True)
        self._ring_b_layer.setHidden_(True)
        self._pulse_layer.setHidden_(True)
...
def _parse_args(argv: list[str]) -> OverlayConfig:
    parser = argparse.ArgumentParser(description="Ptarmigan Flow activity overlay")
