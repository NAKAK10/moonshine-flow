...
Historically, all CLI helpers and command handlers lived in ``moonshine_flow.cli``.
The implementation now resides under ``moonshine_flow.presentation.cli.commands``.
...
from moonshine_flow.presentation.cli import commands as _commands
